    ...
    <div className="relative flex flex-col rounded-[2rem] bg-white p-8 shadow-sm shadow-black/[0.03] dark:bg-white/[0.06]">
      ...
      {plan.badge !== null && (
        <div className="mb-2 mt-1">
          <span className="inline-block rounded-full bg-primary/10 px-3 py-1 font-label text-[9px] font-bold uppercase tracking-[0.15em] text-primary">
            {plan.badge}
          </span>
        </div>
      )}
      ...
      {/* Plan name + price */}
      <div className={plan.badge !== null ? "mb-8" : "mb-8 mt-3"}>
        ...
        <div className="mt-4 flex items-baseline gap-1">
          ...
          <span className="font-label text-sm text-muted-foreground">/mo</span>
        </div>
      ...
      {/* Feature list — flex-1 stretches to equalize card heights */}
      ...
      {/* CTA — identical for every plan */}
      <div className="mt-8">
        <TrackedPlanCTA planName={plan.name} price={plan.price}>
          <Link
            href="/start"
            className="block w-full rounded-full bg-primary py-4 text-center font-label text-[10px] font-bold uppercase tracking-[0.2em] text-white shadow-lg shadow-primary/10 transition-all hover:bg-primary/90 active:scale-[0.98]"
          >
            Get Started
          </Link>
        </TrackedPlanCTA>
  ...
  return (
    <div className="px-6 pb-32 pt-24">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Three pricing cards — identical bg-white, equal height */}
        ...
        {/* All Plans Include */}
        <div className="mt-16 overflow-hidden rounded-[2rem] bg-[var(--ds-surface-low)] dark:bg-white/[0.04]">
